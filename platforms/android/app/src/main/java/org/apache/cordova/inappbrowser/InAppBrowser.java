...
public class InAppBrowser extends CordovaPlugin {
    ...
    public String showWebPage(final String url, HashMap<String, String> features) {
        ...
        Runnable runnable = new Runnable() {
            ...
            private View createHomeButton(int id) {
                View _home;
                Resources activityRes = cordova.getActivity().getResources();
                ImageButton home = new ImageButton(cordova.getActivity());

                int closeResId = activityRes.getIdentifier("home", "drawable", cordova.getActivity().getPackageName());
                Drawable closeIcon = activityRes.getDrawable(closeResId);
                //  if (closeButtonColor != "") home.setColorFilter(android.graphics.Color.parseColor(closeButtonColor));
                home.setImageDrawable(closeIcon);
                ...
                _home.setLayoutParams(closeLayoutParams);

                if (Build.VERSION.SDK_INT >= 16)
                    _home.setBackground(null);
                else
                    _home.setBackgroundDrawable(null);

                _home.setContentDescription("Close Button");
                _home.setId(Integer.valueOf(id));
            ...
            public void run() {
                ...
                /*USER AGENT*/
                String userAgent = "Cpmobileappandroidv1 " + settings.getUserAgentString();
