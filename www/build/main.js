...
var MysettingsPage = /** @class */ (function () {
    ...
    MysettingsPage.prototype.launchDialer = function (n) {
        ...
        this.sim.getSimInfo().then(function (info) {
            ...
            if (_this.platform.is('ios') && info.carrierName != "") {
                _this.placeACallWithDialer(n);
            }
            else if (_this.platform.is('android') && info.networkType != 0) {
                _this.placeACallWithDialer(n);
            }
        });
    };
    MysettingsPage.prototype.placeACallWithDialer = function (n) {
